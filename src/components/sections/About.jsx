        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6 slide-in-left">
              ...
              <p className="text-gray-600 leading-relaxed">
                What drives me is the endless possibility to create solutions
                that can impact people's lives. Whether it's building a mobile
                app that helps users track their daily habits or developing a
                web platform that connects communities, I find joy in turning
                ideas into reality through code.
              </p>
              <p className="text-gray-600 leading-relaxed">
                I'm particularly interested in full-stack development, machine
                learning, and mobile app development. With my university
                education and hands-on project experience, I'm constantly
                learning and working on projects to build my skills.
              </p>
            </div>
