      ...
      <Listbox value={value} onChange={onChange}>
        {() => (
          <div className="relative">
            ...
            <Listbox.Button
              className={`relative w-full cursor-pointer rounded-full bg-white py-2 pl-4 pr-10 text-left shadow-sm border border-gray-200 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-${color}-400 transition-all duration-150 hover:bg-${color}-50 hover:border-${color}-400 text-gray-800`}
            >
                  ...
                  >
                    {({ selected }) => (
                      <>
                        ...
                        {selected ? (
                          <span
                            className={`absolute inset-y-0 left-0 flex items-center pl-3 text-${color}-600`}
                          >
